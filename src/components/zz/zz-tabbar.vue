        ...
        <view class="u-tabbar__content safe-area-inset-bottom" :style="{
            ...
            <view class="u-tabbar__content__item" v-for="(item, index) in list" :key="index" :class="{
                ...
                <view :class="[
                    ...
                    <u-icon :size="midButton && item.midButton ? midButtonSize : iconSize" :name="elIconPath(index)" img-mode="scaleToFill" :color="elColor(index)" :custom-prefix="item.customIcon ? 'custom-icon' : 'uicon'"></u-icon>
                ...
                <view class="u-tabbar__content__item__text" :style="{
                    ...
                    <text class="u-line-1" :style="textStyle">{{item.text}}</text>
                </view>
            </view>
