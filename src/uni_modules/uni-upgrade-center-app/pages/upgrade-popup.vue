...
<script>
	...
	export default {
		...
		onLoad({
			...
			// console.log('localPackageInfo', localPackageInfo,this.sys);
			...
			if(this.sys.versionCode >= Number(localPackageInfo.version)) return uni.navigateBack()
		...
		methods: {
			checkLocalStoragePackage() {
				...
				// console.log('checkLocalStoragePackage',localFilePathRecord,this.sys);
			},
			async closeUpdate() {
				if (this.downloading) {
					if (this.is_mandatory) {
