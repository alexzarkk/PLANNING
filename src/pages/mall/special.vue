    ...
    <view>
        ...
        <view id="tvideo">
            <view class="cu-card case no-card">
                <view class="bg-video flex align-center" style="height: 339rpx;">
                    <video id="myVideo" autoplay src="https://vkceyugu.cdn.bspapp.com/VKCEYUGU-unia9cc9/8383ba60-b889-11ea-8ff1-d5dcf8779628.mp4" :autoplay="true" :muted="false" :show-fullscreen-btn="true" :show-mute-btn="true" :show-play-btn="true" object-fit="cover"></video>
                </view>
                <view class="padding-xs bg-gray flex justify-around">
                    ...
                    <view class="basis-xs flex justify-center solid-left" @tap="addOil">
                        <view class="cu-tag bg-pink round">我要助力</view>
                    </view>
                </view>
            </view>
        </view>
        ...
        <view id="tab1">
            ...
            <block v-for="(c, idx) in peach" :key="idx">
                ...
                <view class="padding-lr padding-top pre-line">
                    <!-- <wxParse :content="c.content"></wxParse> -->
        ...
        <view id="tab2">
            ...
            <view class="cu-card case" v-for="(p, idx) in pics" :key="idx">
                <view class="padding-lr margin-top-sm shadow">
                    <view class="image">
                        <image class="radius" :src="p.url" mode="widthFix" @tap="imgView(pics, idx)"></image>
                    </view>
...
var thiz;
export default {
    components: { zzxbBlog, bannerList, uParse },
    data() {
        return {
            bd: this.bd,
            // #ifndef APP-PLUS
