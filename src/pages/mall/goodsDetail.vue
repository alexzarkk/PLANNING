	...
	<view class="container">
		...
		<view id="tabto0">
			...
			<view class="tui-banner-swiper">
				<swiper :autoplay="true" :interval="5000" :duration="150" :circular="true" :style="{ height: WinWidth + 'px' }"
				 @change="bannerChange">
				...
				<view class="">
					<view class="tui-pro-pricebox tui-padding bg-white">
						...
						<view class="flex flex-direction justify-center" @tap="userEvent(40,30,item)">
							<view class=""><tui-icon :name="item.isFavor ? 'like-fill' : 'like'" :color="item.isFavor?'#ff582e' : '#333'" :size="20"></tui-icon></view> 
			...
			<view class="tui-pro-detail">
				...
				<view class="tui-basic-info tui-mtop tui-radius-all">
					...
					<view class="tui-list-cell tui-last">
						...
						<view class="tui-selected-box">江浙沪皖地区免运费，其他地区参考</view><view class=" text-blue" @tap="href('../deliverFee')">【运费标准】</view>
					</view>
					<view class="tui-guarantee">
						...
						</view><view class="tui-guarantee-item">
							<tui-icon name="circle-selected" :size="14" color="#999"></tui-icon>
						...
						<view class="cu-list bg-white solid menu-avatar sticky-box">
							...
							<scroll-view class="bg-white solid padding-lr" scroll-y :style="'height:'+(WinH*0.5)+'px'">
								<block v-for="(itm, idx) in item.item" :key="idx">
									<button class="my-btn margin-tb-sm"
										:class="itemIdx==idx?'bg-orange light':'bg-gray'"
										:disabled="itm.num<=0"
										:data-id="idx" @tap="itemChange">
