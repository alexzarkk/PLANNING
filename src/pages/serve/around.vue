<template>
    ...
    <view class="maps-container">
        ...
        <view class="search-bar">
            <view class="search-bar-form">
                <view class="search-bar-box">
                    ...
                    <input confirm-type="search" class="search-bar-input" placeholder="查询附近地名" :value="inputVal" :focus="inputShowed" @confirm="bindInput" @input="inputTyping" />
        ...
        <map class="tui-map" :latitude="lat" :longitude="lng" :markers="covers" :scale="zoom" :enable-satellite="true" @markertap="marker" @regionchange="mpEvt"></map>
