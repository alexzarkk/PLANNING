<template>
    <view>
        ...
        <view class="container">
            <lPainter isRenderImage isH5PathToBase64 type="2d" :board="base" ref="painter" custom-style="position: fixed; left: 200%" @progress="progress"></lPainter>
            <view>
                <tui-lazyload-img v-if="poster" width="100%" height="370rpx" @click="previewImage" :src="poster"></tui-lazyload-img>
            </view>
            <button @click="getCanvas">click</button>
        </view>
    </view>
</template>
        ...
        async loadData() {
            ...
            this.base = {
                ...
                "views": [{  // 背景图
                    ...
                    //     "type": "text",
                    //     "text": "周柯",
                    //     "css": { "color": "#FEFBFB", "fontSize": "32rpx", "fontWeight": 400, "height": "40rpx", "left": "122rpx", "textAlign": "center", "top": "610rpx", "width": "120rpx" },
